...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\FightType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\FightType']) ? $this->services['AppBundle\\Form\\FightType'] : ($this->services['AppBundle\\Form\\FightType'] = new \AppBundle\Form\FightType())) && false ?: '_'};
